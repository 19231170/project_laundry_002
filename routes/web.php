...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/database/export', [DatabaseExportController::class, 'index'])->name('database.export.form');
    Route::post('/database/export', [DatabaseExportController::class, 'export'])->name('database.export');
});
