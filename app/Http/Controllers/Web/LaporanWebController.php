...
class LaporanWebController extends Controller
{
    public function index(Request $request)
    {
        ...
        $summary = [
            ...
            'total_pendapatan' => $query->sum('total_setelah_pembulatan'),
    ...
    public function harian()
    {
        ...
        $summary = [
            ...
            'total_pendapatan' => Transaksi::whereDate('tanggal_masuk', $tanggal)->where('status', 'selesai')->sum('total_setelah_pembulatan'),
    ...
    public function bulanan()
    {
        ...
        $summary = [
            ...
            'total_pendapatan' => Transaksi::whereBetween('tanggal_masuk', [$startDate, $endDate])->where('status', 'selesai')->sum('total_setelah_pembulatan'),
        ...
        $dailyData = Transaksi::whereBetween('tanggal_masuk', [$startDate, $endDate])
            ...
            ->selectRaw('DATE(tanggal_masuk) as tanggal, SUM(total_setelah_pembulatan) as pendapatan, COUNT(*) as jumlah')
            ->groupBy('tanggal')
            ->orderBy('tanggal')
            ->get();
